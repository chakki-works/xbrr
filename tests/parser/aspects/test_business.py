...
class TestBusiness(unittest.TestCase):
    ...
    def test_management_analysis(self):
        xbrl = self.get_xbrl()
        feature = xbrl.parse_by(Business).management_analysis
